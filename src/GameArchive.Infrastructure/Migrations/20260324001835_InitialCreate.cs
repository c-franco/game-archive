    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-0000-0000-0000-000000000001"), 1, "Box", 1 },
                    { new Guid("11111111-0000-0000-0000-000000000002"), 1, "Controller", 2 },
                    { new Guid("11111111-0000-0000-0000-000000000003"), 1, "Cables", 3 },
                    { new Guid("11111111-0000-0000-0000-000000000004"), 1, "Manual", 4 },
                    { new Guid("11111111-0000-0000-0000-000000000005"), 0, "Box", 1 },
                    { new Guid("11111111-0000-0000-0000-000000000006"), 0, "Manual", 2 },
                    { new Guid("11111111-0000-0000-0000-000000000007"), 0, "Cartridge/Disc", 3 }
                });
